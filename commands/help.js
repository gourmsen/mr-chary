...
function contestHelp() {
    ...
    .addFields(
        ...
        {name: "`!cry contest options [contest_id] [option=value<=subvalue>]`",     value: "Changes contest options.", inline: false},
        {name: "`!cry contest info [contest_id]`",                                  value: "Shows information about the contest.", inline: false},
        {name: "`!cry contest personal [option=value]`",                            value: "Shows personal statistics about the contest.", inline: false},
        {name: "`!cry contest board [option=value]`",                               value: "Shows the leaderboard.", inline: false},
